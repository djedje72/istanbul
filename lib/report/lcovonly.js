    ...
    writeFileCoverage: function (writer, fc) {
        ...
        Object.keys(functions).forEach(function (key) {
            var stats = functions[key],
                ...
                covered = stats > 0,
                skipped = meta.skip;
            console.log("covered="+covered, "skipped="+skipped);
            console.log('=> FNDA:' + [ (covered || !skipped) ? stats : 1, meta.name ].join(','));
        ...
        Object.keys(branches).forEach(function (key) {
            ...
            branchArray.forEach(function (b) {
                ...
                console.log("BRDA", "line="+line, "key="+key, "i="+i, "covered="+covered, "skipped="+skipped);
                console.log('=> BRDA:' + [line, key, i, (covered || !skipped) ? b : 1].join(','));
